/* =================================================================
   CityMate — India States & Cities dataset
   Used by the "Choose your location" feature on the dashboard.
   Keys are state names, values are arrays of major cities.
   Feel free to extend the city lists — this covers the most
   commonly searched cities per state/UT.
   ================================================================= */
